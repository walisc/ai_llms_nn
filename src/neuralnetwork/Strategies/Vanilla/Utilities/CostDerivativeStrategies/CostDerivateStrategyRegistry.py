from neuralnetwork.Strategies.Vanilla.Utilities.CostDerivativeStrategies.Squared.CostDerivativeStrategiesSquared import CostDerivativeStrategiesSquared
